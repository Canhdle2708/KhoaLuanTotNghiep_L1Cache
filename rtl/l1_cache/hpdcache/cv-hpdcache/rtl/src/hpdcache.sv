...
(
    ...
    logic                  vbuf_fwd_req;
    hpdcache_nline_t       vbuf_fwd_nline;
    hpdcache_word_t        vbuf_fwd_word;
    logic                  vbuf_fwd_hit;
    hpdcache_req_data_t    vbuf_fwd_data;
    logic                  vbuf_fwd_rsp_valid;
    ...
    logic                  _unused_vbuf_fwd_rsp_valid;
    ...
    hpdcache_ctrl #(
        ...
        .vbuf_fwd_req_o                     (vbuf_fwd_req),
        .vbuf_fwd_nline_o                   (vbuf_fwd_nline),
        .vbuf_fwd_word_o                    (vbuf_fwd_word),
        .vbuf_fwd_hit_i                     (vbuf_fwd_hit),
        .vbuf_fwd_data_i                    (vbuf_fwd_data),
        .vbuf_fwd_rsp_valid_o               (vbuf_fwd_rsp_valid),
    ...
    assign _unused_vbuf_fwd_rsp_valid = 1'b0 && vbuf_fwd_rsp_valid;
    ...
    hpdcache_vbuf #(
        ...
        .fwd_req_i                     (vbuf_fwd_req),
        .fwd_nline_i                   (vbuf_fwd_nline),
        .fwd_word_i                    (vbuf_fwd_word),
        .fwd_hit_o                     (vbuf_fwd_hit),
        .fwd_data_o                    (vbuf_fwd_data),
