...
(
    ...
    output logic                  vbuf_fwd_req_o,
    output hpdcache_nline_t       vbuf_fwd_nline_o,
    output hpdcache_word_t        vbuf_fwd_word_o,
    input  logic                  vbuf_fwd_hit_i,
    input  hpdcache_req_data_t    vbuf_fwd_data_i,
    output logic                  vbuf_fwd_rsp_valid_o,
    ...
    logic                    core_rsp_vbuf_fwd_valid;
    hpdcache_req_tid_t       core_rsp_tid;
    hpdcache_req_sid_t       core_rsp_sid;
    hpdcache_req_data_t      core_rsp_vbuf_fwd_data;
    ...
    hpdcache_ctrl_pe #(
        ...
        .st1_vbuf_fwd_hit_i                 (vbuf_fwd_hit_i),
        ...
        .vbuf_fwd_rsp_valid_o               (st1_vbuf_fwd_rsp_valid),
    ...
    assign vbuf_fwd_req_o      = vbuf_replacement_owner_en_i &
                                 st1_req_valid_q &
                                 st1_req_is_load &
                                 ~st1_req_is_uncacheable &
                                 ~st1_req_is_cmo_prefetch &
                                 ~cachedir_hit_o;
    assign vbuf_fwd_nline_o    = st1_req_nline;
    assign vbuf_fwd_word_o     = st1_req_word;
    //  }}}
    ...
    if (HPDcacheCfg.u.lowLatency) begin : gen_st2_core_rsp_comb
        ...
        assign core_rsp_vbuf_fwd_valid = st1_vbuf_fwd_rsp_valid;
        assign core_rsp_vbuf_fwd_data = vbuf_fwd_data_i;
        ...
        begin : st2_core_rsp_ff
            if (!rst_ni) begin
                ...
                core_rsp_sid <= 'h0;
                core_rsp_tid <= 'h0;
                core_rsp_vbuf_fwd_valid <= 1'b0;
                core_rsp_vbuf_fwd_data <= '0;
            end else begin
                ...
                core_rsp_vbuf_fwd_valid <= st1_vbuf_fwd_rsp_valid;
                core_rsp_vbuf_fwd_data <= vbuf_fwd_data_i;
            end
        end
    end
    ...
    assign core_rsp_o.rdata   = (refill_core_rsp_valid_i ? refill_core_rsp_i.rdata :
                                ...
                                (core_rsp_vbuf_fwd_valid ? core_rsp_vbuf_fwd_data :
                                                           data_req_read_data))));
    ...
    assign vbuf_fwd_rsp_valid_o = core_rsp_vbuf_fwd_valid;
    //  }}}
