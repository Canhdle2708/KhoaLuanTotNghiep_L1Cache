...
(
    ...
    input  logic                   st1_vbuf_fwd_hit_i,
                ...
                //  {{{
                    ...
                    begin
                        ...
                        if (!cachedir_hit_i) begin
                            ...
                            //  Load forwarding: the newest copy is already captured in VBUF.
                            //  Respond directly from VBUF instead of refilling stale RAM data.
                            if (vbuf_replacement_owner_en_i &&
                                st1_req_is_load_i &&
                                st1_vbuf_fwd_hit_i) begin
                                st1_rtab_commit_o = st1_req_rtab_i;
                                st1_rsp_valid_o = st1_req_need_rsp_i;
                                vbuf_fwd_rsp_valid_o = st1_req_need_rsp_i;
                                evt_read_req_o = 1'b1;
                            end
                    ...
                    if (st1_req_is_store_i && !st1_err_o) begin
                        ...
                        //  The newest copy is still held by VBUF. Wait until it
                        //  reaches memory before refilling the line again.
                        if (vbuf_replacement_owner_en_i && st1_vbuf_check_hit_i) begin
                            st1_rtab_alloc = 1'b1;
                            st1_rtab_vbuf_hit_o = 1'b1;
